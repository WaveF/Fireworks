  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "digit_sequence_exponent": parse_digit_sequence_exponent,
        "wsp": parse_wsp
      };
      ...
      function parse_moveto() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, c, seq) { return {type:"moveto", relative:c=='m', args:seq} })(pos0, result0[0], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_moveto_argument_sequence() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, first, more) { return all(first, more); })(pos0, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_closepath() {
        ...
        if (result0 !== null) {
          result0 = (function(offset) { return {type:"closepath" } })(pos0);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_lineto() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, c, args) { return {type:"lineto", relative:c=='l', args:args} })(pos0, result0[0], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_horizontal_lineto() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, c, args) { return {type:"horizontal lineto", relative:c=='h', args:args} })(pos0, result0[0], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_coordinate_sequence() {
        ...
        if (result0 !== null) {
          ...
          result2 = result2 !== null ? result2 : "";
          if (result2 !== null) {
            result3 = parse_coordinate_sequence();
            if (result3 !== null) {
      ...
      function parse_vertical_lineto() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, c, args) { return {type:"vertical lineto", relative:c=='v', args:args} })(pos0, result0[0], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_curveto() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, c, args) { return {type:"curveto", relative:c=='c', args:args} })(pos0, result0[0], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_curveto_argument() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, a, b, c) { return { pt1: { x:a.x, y:a.y }, pt2: { x:b.x, y:b.y }, pt: { x:c.x, y:c.y } } })(pos0, result0[0], result0[2], result0[4]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_smooth_curveto() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, c, args) { return {type:"smooth curveto", relative:c=='s', args:args} })(pos0, result0[0], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_smooth_curveto_argument() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, b, c) { return { pt2: { x:b.x, y:b.y }, pt: { x:c.x, y:c.y } } })(pos0, result0[0], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_quadratic_bezier_curveto() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, c, args) { return {type:"quadratic curveto", relative:c=='q', args:args} })(pos0, result0[0], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_quadratic_bezier_curveto_argument() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, a, b) { return { pt1: { x:a.x, y:a.y }, pt: { x:b.x, y:b.y } } })(pos0, result0[0], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_smooth_quadratic_bezier_curveto() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, c, args) { return {type:"smooth quadratic curveto", relative:c=='t', args:args} })(pos0, result0[0], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_elliptical_arc() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, c, args) { return {type:"elliptical arc", relative:c=='a', args:args} })(pos0, result0[0], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_elliptical_arc_argument() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, rx, ry, xrot, large, sweep, xy) { return { rx:rx, ry:ry, xAxisRotation:xrot.join('')*1, largeArc:large=='1', sweep:sweep=='1', pt: { x:xy.x, y:xy.y } } })(pos0, result0[0], result0[2], result0[4], result0[6], result0[8], result0[10]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_number() {
        ...
        if (result0 !== null) {
          result1 = parse_digit_sequence_exponent();
          if (result1 !== null) {
            result0 = [result0, result1];
          } else {
            result0 = null;
      ...
      function parse_digit_sequence_exponent() {
        var result0, result1, result2, result3, result4;
        var pos0, pos1;
        ...
        if (result0 !== null) {
          result0 = (function(offset, digits) { return flatten(digits).join("")*1 })(pos0, result0);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function computeErrorPosition() {
        ...
        return { line: line, column: column };
      		...
      		function flatten(a)
      		{
      			for (var i = 0, l = a.length; i < l; ++i) {
      				...
      				if (o.constructor == Array) {
      					flatten(o);
      				} else if (o && (typeof o != "string" || !WhitespaceRE.test(o))) {
      						// only push non-null objects, in order to skip whitespace strings
      					result.push(o);
      				}
      			}
      		}
      	...
      	function all(first, more)
      	{
      	    var a = [first];
      
      		for (var i = 0, len = more.length > 1 && more[1].length; i < len; ++i) {
      		    a[i + 1] = more[1][i]
      		}
